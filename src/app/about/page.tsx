...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "ansh.gupta@gmail.com",
    href: "mailto:ansh.gupta@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/anshgupta0001/",
    content: "/anshgupta0001",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/anshgupta110805",
    content: "/anshgupta110805",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Ansh Gupta</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Ansh, a Fullstack developer passionate about
